...
# Command line argument for XML file
xml_file = sys.argv[1] if len(sys.argv) > 1 else "Statement_206598021.xml"
output_file = sys.argv[2] if len(sys.argv) > 2 else "templates/Statement_reference.xlsx"
