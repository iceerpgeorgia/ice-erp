// Update counteragents to mark them as employees in Supabase
...
async function updateEmployeeStatus() {
  console.log('\n========================================');
  console.log('  UPDATE EMPLOYEE STATUS IN SUPABASE');
  console.log('========================================\n');
  console.log(`Updating ${EMPLOYEE_UUIDS.length} counteragents...\n`);

  try {
    // Update all counteragents with these UUIDs to is_emploee = true
    ...
    console.log('========================================\n');
    console.log(`✓ Correctly marked as employee: ${updated.length}`);
    console.log(`✗ Still not marked as employee: ${notUpdated.length}\n`);

    if (notUpdated.length > 0) {
      console.log('NOT UPDATED (still is_emploee ≠ true):');
    ...
    console.log('Sample of updated employees:');
