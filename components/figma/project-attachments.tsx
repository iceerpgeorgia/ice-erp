...
export function ProjectAttachments({
  ...
  const handleUpload = async () => {
    ...
    if (!documentDate) { alert('Please select a document date'); return; }
                ...
                <div className="border rounded-lg p-4 space-y-4 bg-accent/20">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="proj-document-date" className="text-sm">Document Date <span className="text-destructive">*</span></Label>
