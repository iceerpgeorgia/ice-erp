...
export async function POST(req: NextRequest) {
  try {
    ...
    const created = await prisma.counteragent.create({
      data: {
        name: body.name?.trim(),
        identificationNumber: body.identification_number ?? null,
        birthOrIncorporationDate: body.birth_or_incorporation_date
          ? new Date(body.birth_or_incorporation_date)
          : null,
        sex: body.sex ?? null,
        pensionScheme: body.pension_scheme ?? null,
        ...
        orisId: body.oris_id ?? null,

        // Only set UUIDs - triggers will populate the name fields
        countryUuid: body.country_uuid ?? null,
        entityTypeUuid: body.entity_type_uuid ?? null,
        isActive: body.is_active ?? true,
        isEmploee: body.is_emploee ?? null,
        wasEmploee: body.was_emploee ?? null,
        updatedAt: new Date(),
      },
      select: {
        id: true,
  ...
  try {
    ...
    const updated = await prisma.counteragent.update({
      ...
      data: {
        ...
        identificationNumber: body.identification_number !== undefined ? body.identification_number : undefined,
        birthOrIncorporationDate: body.birth_or_incorporation_date !== undefined 
          ? (body.birth_or_incorporation_date ? new Date(body.birth_or_incorporation_date) : null) 
          : undefined,
        sex: body.sex !== undefined ? body.sex : undefined,
        pensionScheme: body.pension_scheme !== undefined ? body.pension_scheme : undefined,
        // Don't update entity_type or country - they are auto-populated by trigger from UUIDs
        addressLine1: body.address_line_1 !== undefined ? body.address_line_1 : undefined,
        addressLine2: body.address_line_2 !== undefined ? body.address_line_2 : undefined,
        zipCode: body.zip_code !== undefined ? body.zip_code : undefined,
        ...
        directorId: body.director_id !== undefined ? body.director_id : undefined,
        email: body.email !== undefined ? body.email : undefined,
        phone: body.phone !== undefined ? body.phone : undefined,
        orisId: body.oris_id !== undefined ? body.oris_id : undefined,
        // Only update UUIDs - triggers will populate the name fields
        countryUuid: body.country_uuid !== undefined ? body.country_uuid : undefined,
        entityTypeUuid: body.entity_type_uuid !== undefined ? body.entity_type_uuid : undefined,
        internalNumber: body.internal_number !== undefined ? body.internal_number : undefined,
        isActive: body.is_active !== undefined ? body.is_active : undefined,
        isEmploee: body.is_emploee !== undefined ? body.is_emploee : undefined,
        wasEmploee: body.was_emploee !== undefined ? body.was_emploee : undefined,
      },
      select: {
        id: true,
        createdAt: true,
