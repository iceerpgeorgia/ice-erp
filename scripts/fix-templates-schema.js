...
const migration = `
-- Drop old templates table and recreate with new schema
DROP TABLE IF EXISTS "templates" CASCADE;

-- CreateTable templates with new schema
...
async function applyMigration() {
  ...
  try {
    ...
    console.log('\nDropping old templates table and recreating with new schema...');
    ...
    console.log('\n✓ Templates table created with columns:');
