...
print("\n🗑️  Cleaning up raw tables and consolidated data...")

# Drop partition table and all partitions
try:
    cursor.execute("DROP TABLE IF EXISTS bog_gel_raw_statements CASCADE")
    print("✅ Dropped bog_gel_raw_statements partition table")
except Exception as e:
    print(f"⚠️  bog_gel_raw_statements: {e}")

# Drop dedicated account table
try:
    cursor.execute("DROP TABLE IF EXISTS bog_gel_raw_893486000 CASCADE")
    print("✅ Dropped bog_gel_raw_893486000 table")
except Exception as e:
    print(f"⚠️  bog_gel_raw_893486000: {e}")

# Truncate consolidated_bank_accounts
try:
    cursor.execute("TRUNCATE TABLE consolidated_bank_accounts CASCADE")
    print("✅ Truncated consolidated_bank_accounts table")
except Exception as e:
    print(f"❌ Error truncating consolidated_bank_accounts: {e}")

# Create fresh raw table for account 893486000
print("\n📊 Creating fresh raw table...")
...
print("✅ Created bog_gel_raw_893486000 table with indexes")
